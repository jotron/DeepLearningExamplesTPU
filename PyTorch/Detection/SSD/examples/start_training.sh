...
python3 main.py --backbone resnet50 --batch-size 32 --warmup 300 --data $DATA_DIR --no-cuda --seed 42 --log-interval=10 --parallel_loader --num-workers=4 --suppress_loss_report --accumulation=4
